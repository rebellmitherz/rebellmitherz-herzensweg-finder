...
return ( <div> <h2>Was ist deine Situation?</h2>
...
return ( <div> <h2>Deine Analyse</h2>
...
```
  ...
  <a href={PRODUCT_MAP.elternschutzpaket.href}>
    Zum Produkt
  </a>
</div>
```
...
```
  {step === "analysis" && (
    <StepAnalysis onComplete={() => setStep("email-gate")} />
  )}

  {step === "email-gate" && (
    <StepEmailGate onUnlock={() => setStep("result")} />
  )}
